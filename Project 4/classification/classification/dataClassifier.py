...
def enhancedFeatureExtractorDigit(datum):
    ...
    for i in height:
        ...
        #   print features[(i,j)]
          ...
          if feature1 == 0 and features[(i,j)] > 0:
            feature1 = 1

          if feature1 == 1 and features[(i,j)] == 0:
            feature2 = 1

          if feature1 == 1 and feature2 == 1 and features[(i,j)] > 0:
            feature3 = 1

          if feature3 == 1 and feature1 == 1 and feature2 == 1 and features[(i,j)] == 0:
            feature4 = feature4 + 1

          if feature4 <= 0:
            # print "if"
            # print "if features[(i,j)]"
            # print features[(i,j)]
            # print "counter"
            # print counter
            features[counter] = 0
            ...
            # print "else"
            # print "else features[(i,j)]"
            # print features[(i,j)]
            features[counter] = 1
            # print "features[counter]"
            # print features[counter]
            # print "counter"
            # print counter
        # print features
...
def enhancedPacmanFeatures(state, action):
    ...
    foodlocations = state.getFood().asList()
    for food in foodlocations:
      distance = [util.manhattanDistance(food,newPosition)]
    if "Stop" in action:
        features[action,'val'] = -.001
        # print "features"
        # print features
        return features
    ...
    for ghostState in newGhostStates:
      ...
      if ghostPosition == newPosition and ghostState.scaredTimer == 0:
            features[action,'val'] = -250
            # print "features"
            # print features
            return features
    # print "max(distance)"
